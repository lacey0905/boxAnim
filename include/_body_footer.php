<footer id="footer">
    <div class="ft_nav">
        <ul class="container">
            <li class="menu">
                <span><a href=""><b>당원가입</b></a></span>
                <span><a href=""><b>당비납부</b></a></span>
                <br/>
                <span><a href="">찾아오시는길</a></span>
                <span><a href="javascript:modalOpen('personalInfoPopup');">개인정보 처리방침</a></span>
                <span><a href="javascript:modalOpen('termServicePopup');">이용약관</a></span>
    ...
    <div class="ft_info">
        <ul class="container">
            ...
            <li class="addr">
                <p>[우 07238] 서울특별시 영등포구 국회대로74길 12 국민의힘</p><!-- 11/10 수정 -->
                <p>
            ...
            <li class="last">
                <div class="csite">
                    ...
                    <div class="csel">
                        <div class="sl">
                            <select name="" id="">
                                <option value="">위원회 및 연구원</option>
                                <option value="">여의도연구원</option>
                            </select>
                            <a href="">이동</a>
                        </div>
                    </div>
    ...
    <div class="ft_quick">
        <ul>
            ...
            <li class="pnews"><a href="">후원</a></li>
            <li class="in"><a href=""><span>온라인<br/>입당</span></a></li>
            <li class="support"><a href="">후원</a></li>
            <li class="ch"><a href="">채널추가</a></li>
        </ul>
    </div>
    <!--//-->
</footer>
...
<!-- ###### 인물 Popup Start ###### //-->
<script>
    function peoplePop(target,table,no) {
        modalOpen(target);
    }
</script>
<div class="modal-wrap scroll" id="peoplePopup">
    <div class="modal-content">
        <div class="modal-body">
            <a href="javascript:modalClose('peoplePopup');" class="close">닫기</a>
            <div class="people-head">
                <div class="thumb">
                    <img src="../img/noimg_logo.png" alt="홍길동">
                </div>
                <div class="info">
                    <dl>
                        <dt>
                    ...
                    <div class="sns">
                        <a href="" class="home">홈페이지</a>
                        <a href="" class="fa">페이스북</a>
                        <a href="" class="etc">기타</a>
            ...
            <div class="people-detail">
                <dl>
                    <dt>학력</dt>
                    <dd>
                        <p><span>~ 1997</span> 영남대학교 대학원 법학박사 학위 취득</p>
                        <p><span>~ 1982</span> 영남대학교 법학과 졸업
                        <p><span>~ 1978</span> 대구 능인고등학교 졸업
                        <p><span>~ 1975</span> 대구 경상중학교 졸업
                    </dd>
                </dl>
                <dl>
                    <dt>경력</dt>
                    <dd>
                        <p><span>2015~2016</span> 국회 정보위원장</p>
                        <p><span>2014~2015</span> 새누리당 정책위의장</p>
                        <p><span>2009~2010</span> 초대 특임장관</p>
                        <p><span>2004~</span> 대구 수성구갑 국회의원(5선)</p>
                    </dd>
                </dl>
            </div>
        </div>
        ...
        <div class="modal-body">
            <div class="modal-agree-wrap">         
                ...
                <p>
                    ...
                    1. 파기절차<br/>
                    < 국민의힘 > 은(는) 파기 사유가 발생한 개인정보를 선정하고, < 국민의힘 > 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
                    2. 파기방법<br/>
                ...
                <h4>제10조(개인정보의 열람청구를 접수·처리하는 부서)</h4>
                <p>
    ...
    <div class="modal-content">
        <div class="modal-body">
            <div class="share-wrap">
                ...
                <div class="copy-wrap">
                    <input type="text" id="textbox-url" value="<?=$_SERVER[ "HTTP_HOST" ].$_SERVER[ "REQUEST_URI" ]?>" readonly>
...
<!-- SCRIPT //-->
<script src="/ppp/js/jquery-ui.min.js"></script>
<script src="/ppp/js/jquery.bxslider.min.js"></script>
<script src="/ppp/js/sectionDisplay.js"></script>
<script src="/ppp/js/lottie-player.js"></script>
<script src="/ppp/js/common.js"></script>
<!--//-->
